...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 830192764309921562),
      name: 'ContactModel',
      lastPropertyId: const obx_int.IdUid(3, 3040802049152996474),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 4310299659168036017),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 4480326380706640665),
            name: 'name',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 3040802049152996474),
            name: 'number',
            type: 9,
            flags: 0)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 830192764309921562),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    ContactModel: obx_int.EntityDefinition<ContactModel>(
        ...
        objectFromFB: (obx.Store store, ByteData fbData) {
          ...
          final object =
              ContactModel(id: idParam, name: nameParam, number: numberParam);
